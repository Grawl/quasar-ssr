/*
This file runs in a Node context (it's NOT transpiled by Babel), so use only the ES6 features that are supported by your Node version. https://node.green/
...
If you are looking to add common DEV & PROD logic to the express app, then use `src-ssr/extension.js`
 */
...
app.get('*', (req, res) => {
	...
	the following headers help protect your site from common XSS attacks in browsers that respect headers you will probably want to use .env variables to drop in appropriate URLs below, and potentially look here for inspiration: https://ponyfoo.com/articles/content-security-policy-in-express-apps
	*/
